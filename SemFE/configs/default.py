...
_CN.LOFTR.FPN = CN()
_CN.LOFTR.FPN.D_MODEL = 392
_CN.LOFTR.FPN.D_FFN = 392
_CN.LOFTR.FPN.NHEAD = 8
_CN.LOFTR.FPN.LAYER_NAMES = ['self'] * 4
_CN.LOFTR.FPN.ATTENTION = 'linear'
_CN.LOFTR.FPN.INITIAL_DIM = 128
_CN.LOFTR.FPN.BLOCK_DIMS = [128, 196, 256, 392]  # s1, s2, s3

# 1. LoFTR-backbone (local feature CNN) config
_CN.LOFTR.RESNETFPN = CN()
_CN.LOFTR.RESNETFPN.INITIAL_DIM = 128
_CN.LOFTR.RESNETFPN.BLOCK_DIMS = [128, 196, 256, 392]  # s1, s2, s3

_CN.LOFTR.START = CN()
_CN.LOFTR.START.D_MODEL = 256
_CN.LOFTR.START.D_FFN = 256
_CN.LOFTR.START.NHEAD = 8
_CN.LOFTR.START.LAYER_NAMES = ['self', 'cross'] * 4
_CN.LOFTR.START.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.LOFTR.START.TEMP_BUG_FIX = True
...
_CN.LOFTR.COARSE.LAYER_NAMES = ['self', 'cross'] * 8
...
_CN.LOFTR.UPDOWN = CN()
_CN.LOFTR.UPDOWN.D_MODEL_16 = 392
_CN.LOFTR.UPDOWN.D_MODEL_8 = 256
_CN.LOFTR.UPDOWN.D_MODEL_4 = 196

# 5. CLASS stage
_CN.LOFTR.CLASS = CN()
_CN.LOFTR.CLASS.D_MODEL_CLASS = 256
_CN.LOFTR.CLASS.D_FFN = 256
_CN.LOFTR.CLASS.NHEAD = 8
_CN.LOFTR.CLASS.LAYER_NAMES = ['self'] * 4
_CN.LOFTR.CLASS.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.LOFTR.CLASS.TEMP_BUG_FIX = True

_CN.LOFTR.CLASS_TRANS = CN()
_CN.LOFTR.CLASS_TRANS.D_MODEL = 256
_CN.LOFTR.CLASS_TRANS.D_FFN = 256
_CN.LOFTR.CLASS_TRANS.NHEAD = 8
_CN.LOFTR.CLASS_TRANS.LAYER_NAMES = ['self', 'cross'] * 4
_CN.LOFTR.CLASS_TRANS.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.LOFTR.CLASS_TRANS.TEMP_BUG_FIX = True

_CN.LOFTR.INTERACTIVE = CN()
_CN.LOFTR.INTERACTIVE.D_MODEL = 256
_CN.LOFTR.INTERACTIVE.D_FFN = 256
_CN.LOFTR.INTERACTIVE.NHEAD = 8
_CN.LOFTR.INTERACTIVE.LAYER_NAMES = ['self', 'cross'] * 4
_CN.LOFTR.INTERACTIVE.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.LOFTR.INTERACTIVE.TEMP_BUG_FIX = True
