...
from models.SFE_module import SFE_module
from models.SIE_module import SIE_module
...
class MatchingNet(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.MFE_backbone = MFE_backbone(config['loftr'])
        self.SFE_module = SFE_module(config['loftr'])
        self.SIE_module = SIE_module(config['loftr'])
    ...
    def forward(self, samples0, samples1, gt_matrix):
        ...
        feat_c0_8, feat_c1_8, feat_f0_2, feat_f1_2 = self.MFE_backbone(samples0, samples1)
        feat_c0_8_2, feat_c1_8_2 ,Sem_K_query, classnum_query, Sem_K_refer, classnum_refer = self.SFE_module(feat_c0_8, feat_c1_8)
        feat_c0_8_final, feat_c1_8_final= self.SIE_module(feat_c0_8_2, feat_c1_8_2 ,Sem_K_query, classnum_query, Sem_K_refer, classnum_refer)
